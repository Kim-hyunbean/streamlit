...
st.image('https://raw.githubusercontent.com/Kim-hyunbean/streamlit/blob/main/%EB%A1%9C%EA%B3%A0.png', width=200)
# tabs 만들기
...
with tab1:
    ...
    with st.form(key='tab1_first'):
        ...
        if st.form_submit_button(label='위치조회'):
            ...
            display_df = pd.read_csv('https://raw.githubusercontent.com/Kim-hyunbean/streamlit/blob/main/%EC%96%91%EB%B4%89qhd.csv',encoding='utf-8')
            display_df2 = pd.read_csv('https://raw.githubusercontent.com/Kim-hyunbean/streamlit/blob/main/%EC%84%9C%EC%9A%B8%EC%8B%9C%EC%86%8C%EB%B0%A9%EC%84%9C%EC%9C%84%EC%B9%98.csv',encoding='utf-8')
...
with tab2:
    ...
    with st.form(key='tab2_second'):
        ...
        if st.form_submit_button(label='위치조회'):
            ...
            display_df = pd.read_csv('https://raw.githubusercontent.com/Kim-hyunbean/streamlit/blob/main/%EC%96%91%EB%B4%89qhd.csv',encoding='utf-8')
            display_df2 = pd.read_csv('https://raw.githubusercontent.com/streamlit/blob/main/%EC%84%9C%EC%9A%B8%EC%8B%9C%EC%86%8C%EB%B0%A9%EC%84%9C%EC%9C%84%EC%B9%98.csv',encoding='utf-8')
...
with tab3:
    ...
    display_df = pd.read_csv('https://github.com/Kim-hyunbean/streamlit/blob/main/%EC%96%91%EB%B4%89qhd.csv',encoding='utf-8')
    display_df2 = pd.read_csv('https://github.com/Kim-hyunbean/streamlit/blob/main/%EA%BD%83%EC%A7%80%EB%8F%84.csv',encoding='utf-8')
